setwd("/omics/groups/OE0246/internal/guz/cola_hc/examples/BuettnerESC")
library(cola)
...
library(scRNAseq)
data = readRDS('/omics/groups/OE0246/internal/guz/cola_hc/examples/BuettnerESC/BuettnerESC_data.rds')
